...
export default function Balances({ accountAddress, source1Balances, source2Balances, targetBalances, onClose }: BalancesProps) {
  return (
    <div className="absolute w-full h-full top-0 left-0 flex items-center justify-center gap-2 bg-gray-400/50 z-50">
      <div className="flex flex-col justify-center gap-2 bg-white p-4 rounded-md">
        ...
        <button className="w-full bg-blue-500 text-white p-2 rounded-md" onClick={onClose}>Close</button>
      </div>
    </div>
  )
}
