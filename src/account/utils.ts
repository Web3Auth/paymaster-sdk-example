...
import { bytesToBigInt, createWalletClient, encodeFunctionData, type Hex, hexToBytes, http, parseAbi } from 'viem'
...
export const isRIP7212SupportedNetwork = (chainId: number): boolean => RIP7212_SUPPORTED_NETWORKS.includes(chainId)
 ...
 */
export const base64FromUint8Array = (uint8Arr: Uint8Array, urlMode: boolean): string => {
