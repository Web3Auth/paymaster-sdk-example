export const AUTH_PAYMASTER_ABI = [
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: "bytes", name: "paymasterData", type: "bytes" }],
    name: "decodePaymasterData",
    outputs: [
      {
        components: [
        ...
        internalType: "struct AuthPaymaster.PaymasterContext",
        name: "context",
        type: "tuple",
      },
    ],
  ...
  { inputs: [], name: "getDeposit", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "opHash", type: "bytes32" },
      { internalType: "uint48", name: "validUntil", type: "uint48" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "guarantor", type: "address" },
      { internalType: "uint48", name: "validUntil", type: "uint48" },
      { internalType: "bytes", name: "guarantorSig", type: "bytes" },
    ],
